  ...
  return (
    <MainLayout>
          ...
          <div className="overview grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 md:gap-8">
            {overviewData.map((item, i) => (
              <div className="space-y-1 md:space-y-2 w-full" key={i}>
                ...
                {item.url.length === 0 ? (
                  <p className="font-semibold dark:font-medium text-md md:text-xl text-whiteAlpha-72">{item.text}</p>
                ) : (
                  <Link
                    href={item.url}
          ...
          <div className="project-overview mt-16">
            <div className="flex flex-col md:flex-row gap-4 md:gap-40">
              ...
              <p className="w-full text-md md:text-xl font-normal dark:font-light text-whiteAlpha-56 leading-relaxed">
                <span className="font-medium text-white/90"> The EBL Fund Transfer feature </span>
        ...
        <div className="container">
          <div className="segments space-y-16 md:space-y-28">
            <div className="row space-y-8 md:flex gap-16 items-center">
              ...
              <div className="right w-full">
                <div className="space-y-3 md:space-y-5 md:px-12 w-full">
                  <div className="text-2xl md:text-3xl font-semibold dark:font-medium text-white/80">
                    Choose Options
                  </div>

                  <div className="content w-full text-md md:text-xl font-normal dark:font-light text-whiteAlpha-56 leading-relaxed space-y-4">
                    <p>
                      <span className="font-semibold dark:font-medium text-white/90">Fund Transfer: </span> More options
                      visible and ensuring a consistent design throughout. This results in a clearer and more cohesive
                      user experience.
                    </p>
                    <p>
                      <span className="font-semibold dark:font-medium text-white/90">Transfer Mode: </span> There are
                      three options—BEFTN, NPSB, and RTGS—but the borders made it look like six options. Additionally,
                      the old design didn’t provide explanations for these transfer modes. The new UI resolves these
                      issues by clearly displaying the three options and offering explanations for each mode, enhancing
            ...
            <div className="row space-y-8 md:flex gap-16 items-center flex-row-reverse">
              ...
              <div className="right w-full">
                <div className="space-y-3 md:space-y-5 md:px-12 w-full">
                  <div className="text-2xl md:text-3xl font-semibold dark:font-medium text-white/80">Beneficiary</div>
      ...
      <div className="py-16 md:py-120 bg-whiteAlpha-2">
        <div className="container space-y-[120px]">
          <div className="flex flex-col md:flex-row gap-4 md:gap-40">
            <div className="flex-initial w-6/12 text-3xl font-semibold dark:font-medium text-white/80">Outcome</div>
            <p className="w-full text-md md:text-xl font-normal dark:font-light text-whiteAlpha-56 leading-relaxed">
              The redesigned EBL Fund Transfer feature now offers a significantly enhanced user experience, with
              improved navigation, clearer instructions, and better error handling. The modernized interface aligns with
              contemporary mobile banking standards and addresses key usability issues, resulting in a more efficient
