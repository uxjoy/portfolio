...
import { meta, problems, processSteps, researchInsights, solutions } from "./stPayData";

const Section = ({ label, children }: { label: string; children: React.ReactNode }) => (
  <div className="grid w-full grid-cols-1 gap-8 md:grid-cols-4 md:gap-8">
    <h2 className="text-2xl font-medium uppercase leading-[1.2] text-slate-900 pr-10">{label}</h2>
    ...
    <MainLayout>
      <div className="bg-white text-slate-900">
        ...
        <div className="mx-auto flex max-w-[1200px] flex-col items-start gap-4 px-6 pt-20">
          <p className="text-2xl lowercase leading-[1.5] text-[#5dbd25]">app_design</p>
          <h1 className="text-4xl font-semibold capitalize leading-[1.2] md:text-[56px]">ST pay - Digital Wallet</h1>
        </div>
        ...
        <div className="mx-auto mt-12 flex max-w-[1200px] flex-col gap-[100px] px-6 pb-32">
          ...
          <Section label="Solutions">
            <div className="flex w-full flex-col gap-4">
              <h3 className="text-3xl font-semibold leading-[1.2] md:text-[40px]">Design Improvements</h3>
              <p className="text-lg leading-[1.6] md:text-xl">
          ...
          <Section label="Research">
            <div className="flex w-full flex-col gap-3">
              <h3 className="text-3xl font-semibold leading-[1.2] md:text-[40px]">User Research &amp; Insights</h3>
              <p className="text-lg leading-[1.6] md:text-xl">
              ...
              <div className="flex flex-col gap-2 md:flex-row">
                <div className="flex flex-1 flex-col gap-9 bg-white/[0.06] p-8">
                  <div className="flex items-center gap-5">
                    <div className="relative size-[88px] shrink-0 overflow-hidden border-4 border-white/10">
                      <Image
                        className="object-cover"
          ...
          <Section label="Visual Design">
            <h3 className="text-3xl font-semibold leading-[1.2] md:text-[40px]">Visual identity and brand story</h3>
          ...
          <Section label="Results & Outcomes">
            <div className="flex w-full flex-col gap-3">
              <h3 className="text-3xl font-semibold leading-[1.2] md:text-[40px]">Outcomes that moved the needle</h3>
              <p className="text-lg leading-[1.6] md:text-xl">
          ...
          {/*
          <FullImage src="/assets/case-study/st-pay/outcome.png" alt="ST Pay outcome" /> */}
        </div>
      </div>
    </MainLayout>
  );
