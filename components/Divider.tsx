  ...
  return (
    <>
      <div className="divider flex items-center justify-center gap-5 px-1 text-xs md:text-base w-full">
        ...
        <div
          className={`relative inline-table rounded-full p-[1px] w-auto overflow-hidden ${
            !centerText && "figma-border"
          }`}
        >
          {centerText ? (
            ...
            <Link
              href={portfolioLink}
              target="_blank"
              className="relative flex items-center py-1.5 pl-2.5 pr-3 bg-white/5 backdrop-blur-lg border border-white/5 rounded-full group"
            >
              <svg
                width="21"
                height="20"
