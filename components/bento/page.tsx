import {
  ...
  linkedinLink,
  twitterLink,
} from "@/utils/data/aboutTextsData";
import {
  RiArrowRightUpLine,
  RiCloseLine,
  RiDribbbleLine,
        ...
        <div className="flex flex-col md:grid grid-cols-12 grid-rows-3 gap-3 md:gap-5">
          ...
          >
            ...
            <div className="content space-y-1">
              <p className="text-whiteAlpha-72">
                <span className="font-medium text-lg text-white pr-1">
                  {" "}
                  Top 10%{" "}
                </span>{" "}
                of Talent on Upwork
          ...
          >
            ...
            <div className="space-y-1">
              ...
              <p className="text-whiteAlpha-56 text-sm font-light">
                Skilled in various tools and frameworks to create seamless,
                effective UX/UI.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-1">
              ...
              <p className="text-whiteAlpha-56 text-sm font-light leading-relaxed">
                Connect with me across platforms to explore my work, industry
            ...
            <div className="bg-black/20 w-full h-full border border-whiteAlpha-8 rounded-2xl shadow-lg">
              <div className="header flex items-center justify-between p-4 px-5 border-b border-whiteAlpha-8">
                <span className="flex items-center gap-3">
                  ...
                  <p>
                    uxjoy{" "}
                    <span className="text-primary-default font-medium">|</span>
                  </p>
                </span>
          ...
          >
            ...
            <div className="space-y-1">
              ...
              <p className="text-whiteAlpha-56 text-sm font-light">
                Proficient in multiple technologies to build and enhance product
                experiences.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-col items-center justify-center gap-8 pt-12 absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 w-full h-full">
              ...
              <div className="text-center space-y-1 w-full">
                ...
                <p className="text-whiteAlpha-64 text-sm">
                  23.8041° N, 90.4152° E
                </p>
              </div>
            </div>
