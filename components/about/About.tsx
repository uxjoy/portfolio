  ...
  return (
    <div className="bg-slate-400/ dark:bg-transparent py-12 md:py-120">
      <div className="container space-y-8 md:space-y-14">
        ...
        <div className="inline-grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6">
          <motion.div
            ...
            className="w-full p-5 md:p-6 bg-white border dark:bg-whiteAlpha-4 border-gray-100 dark:border-whiteAlpha-4 rounded-2xl flex items-center"
          >
