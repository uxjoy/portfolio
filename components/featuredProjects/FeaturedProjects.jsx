    ...
    <div className="py-24 md:pt-0 md:pb-24 relative">
      <Splide options={settings} tag="div" aria-label="React Splide Example">
        {featuredProjects.map(({ title, imageURL }, i) => (
          <SplideSlide className="relative h-[500px] rounded-2xl md:rounded-[20px] overflow-hidden" key={i}>
            <div className="flex gap-1.5 items-center bg-black/20 pl-2 pr-3.5 py-2 rounded-full backdrop-blur-sm absolute bottom-7 left-7 z-50 text-sm">
