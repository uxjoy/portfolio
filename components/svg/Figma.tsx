const Figma = () => {
  return (
    ...
    >
      ...
      />
      <path
        d="M12 12C12 9.792 13.792 8 16 8H20V16H16C13.792 16 12 14.208 12 12Z"
        fill="#F24E1E"
      />
      <path
        d="M20 8H24C26.208 8 28 9.792 28 12C28 14.208 26.208 16 24 16H20V8Z"
        fill="#FF7262"
      />
      <path
        d="M12 20C12 17.792 13.792 16 16 16H20V24H16C13.792 24 12 22.208 12 20Z"
        fill="#A259FF"
      />
      <path
